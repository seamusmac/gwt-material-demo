...
public class EditorFormPresenter extends Presenter<EditorFormPresenter.MyView, EditorFormPresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.editorforms)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<EditorFormPresenter> {
    }
